"""Ablation: PropMem without proposition extraction (chunks only)."""
...
SYSTEM_INFO = {
    "architecture": "propmem ablation: no propositions (chunks only)",
...
def run(
    ...
    system = PropMemSystem(use_propositions=False)
