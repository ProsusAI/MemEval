"""PropMem: proposition-based entity-centric retrieval (v5 config)."""
...
from agents_memory.systems._helpers import _qa_results, print_ingest_stats

SYSTEM_INFO = {
    "architecture": "proposition-based retrieval with temporal boost and knowledge updates",
